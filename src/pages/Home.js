        ...
        <div className="cotainerHome" id="/">
            <section className="sectionHome">
                ...
                <footer className="svgI">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="1 0 1420 235" className="svgI">
                        <path fill='#98AFD6' fill-opacity="1" d="M0,226L32.3,200.3C98.6,155,127,213,206,192C274.3,171,343,149,421,144C480,139,549,149,617,165.3C685.7,181,754,203,823,202.7C891.4,203,960,181,1029,192C1097.1,203,1166,215,1234,224.7C1302.9,234,1371,160,1406,128L1440,96L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
